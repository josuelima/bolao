...
In this case I'm using UOL CDN to retrieve the team's images. You can customize it according to the tournament or league your Bolao is running, or use your custom images as well.
