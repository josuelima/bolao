...
Actually I'm using UOL CDN to retrieve the teams images (as its customized for the Fifa World Cup). You can either customize it according to the tournament or league your Bolao is running, or use your custom images.
