...
This app is built on Rails 4 using some gems to make work easier ({RailsAdmin}[https://github.com/sferik/rails_admin] ,{Draper (for decorators)}[https://github.com/drapergem/draper], {Devise}[https://github.com/plataformatec/devise], {Haml}[https://github.com/haml/haml], {Bootstrap 3}[https://github.com/seyhunak/twitter-bootstrap-rails])
...
Actually I'm using UOL CDN to retrieve the teams images (as its customized for the Fifa World Cup). However you can customize it according to the tournament or league your Bolao is running, or use your custom images by implement this feature as well.
